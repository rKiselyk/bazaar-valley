        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AdditionValues = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemsFields", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemsFields_CategoryFields_CategoryFieldId",
                        column: x => x.CategoryFieldId,
                        principalTable: "CategoryFields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemsFields_Items_ItemId",
                        column: x => x.ItemId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemsFields_CategoryFieldId",
                table: "ItemsFields",
                column: "CategoryFieldId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemsFields_ItemId",
                table: "ItemsFields",
                column: "ItemId");
